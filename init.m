...
fc = 100e09;                     % Operating frequency (Hz)
fmin = 50e09;                   
fmax = 250e09;
lambda = v/fc;
...
max_distance_range = 150;      % Maximum unambiguous range, m
range_scale = 0.25;            % m
...
%Код Баркера Фазо-кодо манипулированный сигнал
hwav = phased.PhaseCodedWaveform(...
            'SampleRate', fs, ...
            'PRF', prf, ...
            'Code','Barker',...
            'ChipWidth', pulse_width,...
            'NumChips', 13,...
            'OutputFormat','Pulses', ...
            'NumPulses', num_pulses);
